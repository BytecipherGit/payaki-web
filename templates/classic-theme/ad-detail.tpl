                            ...
                            <div class="aside-body text-center">
                                ...
                                <div class="contact-advertiser">
                                    ...
                                    <button type="button" class="btn btn-warning start_zechat zechat-hide-under-768px"
                                            ...
                                            data-userstatus="{ITEM_AUTHORONLINE}"><i class="fa fa-comment-o"></i> {LANG_CHAT_NOW}</button>

                                    <a href="{QUICKCHAT_URL}" class="btn btn-warning zechat-show-under-768px">{LANG_CHAT_NOW} <i class="fa fa-comment-o"></i></a>
                                    {:IF}
