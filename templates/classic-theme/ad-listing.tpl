            ...
            <div class="category-info">
                ...
                <div class="row recommended-ads">
                    <div class="col-sm-3 col-md-3">
                        ...
                        <div class="tg-sidebartitle enable-filters-button"><h2>{LANG_ADVANCE_SEARCH}: <i class="fa fa-plus"></i></h2></div>
                        <div id="custom-field-block" class='sidebar-container section IF("{SHOWCUSTOMFIELD}"=="0"){ hidden {:IF}'>
                                                    ...
                                                    <div style="border: 1px solid #f3f3f3;">
                                                        ...
                                                        <div class="item-info {ITEM2.highlight_bg}">
                                                            ...
                                                            <div class="ad-info">
                                                                <h4 class="item-title">
                                                                    IF("{ITEM2.sub_image}"!=""){
                                                                    <img src="{ITEM2.sub_image}" width="16px" alt="{ITEM2.sub_title}" title="{ITEM2.sub_title}"/>
                                                                    {:IF}
