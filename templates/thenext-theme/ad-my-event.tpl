        ...
        <div class="row">
                        ...
                        <div class="dashboard-nav-container">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="My Event Ads">
                                        ...
                                        <li class="active"><a href="{LINK_MYEVENTADS}"><i class="icon-feather-briefcase"></i> Event Ads <span class="nav-tag">{MYEVENTADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-briefcase"></i> My Event Ads</h3>
                    </div>
