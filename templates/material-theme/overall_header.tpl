            ...
            <div class="header-left">
                ...
                <nav class="navi main-nav">
                    <ul>
                        ...
                        IF("{LANG_SEL}"=="1"){
                        <li>
                            <a href="#"><button class="btn btn-default" type="button">{LANG_CODE}<span
                                            class="caret"></span></button></a>
                            <ul class="sub-menu">
                                {LOOP: LANGS}
                                    <li><a href="{LINK_HOME}/{LANGS.code}">{LANGS.name}</a></li>
                                {/LOOP: LANGS}
                            </ul>
                        </li>
                        {:IF}
                ...
                <ul class="account-action">
                    <li>
                        ...
                        <div class="account-dropdown">
                            <ul>
                                IF("{LOGGED_IN}"=="0"){
                                <li><a href="{LINK_LOGIN}" class="waves-effect"><i class="fa fa-user"></i> {LANG_SIGN_IN}</a></li>
