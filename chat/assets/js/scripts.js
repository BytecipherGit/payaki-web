$(document).ready(function () {
  ...
  if ($(".user-list").has(".user-who-wrote-you")) {
    $(".user-list")
      .find(".user-who-wrote-you")
      .each(function () {
        alreadyInsertedUserListItem.push(
          "profile-" + $(this).find("a").attr("data-id")
        );
      });
  }
  ...
  $(document).on("click", ".searched-user", (e) => {
    ...
    if (
      $.inArray("profile-" + user_id, insertedUserListItem) === -1 &&
      $.inArray("profile-" + user_id, alreadyInsertedUserListItem) === -1
    ) {
