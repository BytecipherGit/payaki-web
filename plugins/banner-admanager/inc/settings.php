...
$options = array (
	...
	"from_name" => "Banner Manager",
	"from_email" => "helpdesk.bylancer@gmail.com",
	"success_email_subject" => "Payment completed",
	"success_email_body" => "Dear {payer_name},".PHP_EOL.PHP_EOL."Thank you for your payment for \"{banner_title}\".".PHP_EOL.PHP_EOL."Thanks,".PHP_EOL."Banner Manager",
	"failed_email_subject" => "Payment not completed",
	"failed_email_body" => "Dear {payer_name},".PHP_EOL.PHP_EOL."Thank you for your payment. Unfortunately, it was not completed.".PHP_EOL."Payment status: {payment_status}.".PHP_EOL."We will review your payment shortly.".PHP_EOL.PHP_EOL."Thanks,".PHP_EOL."Banner Manager",
	"stats_email_subject" => "Statistics",
	"stats_email_body" => "Dear Sir or Madam,".PHP_EOL.PHP_EOL."We would like to inform you that we have finished showing your banner \"{banner_title}\".".PHP_EOL."{statistics}".PHP_EOL.PHP_EOL."You can publish new banner on this page: {signup_page}.".PHP_EOL.PHP_EOL."Thanks,".PHP_EOL."Banner Manager",
	"currency" => "USD",
	"minimum_days" => 10,
	"signup_page" => $link['ADVERTISE_HERE'],
	"enable_approval" => "",
	"approved_email_body" => "Dear Sir or Madam,".PHP_EOL.PHP_EOL."We would like to inform that your banner \"{banner_title}\" was approved.".PHP_EOL.PHP_EOL."Thanks,".PHP_EOL."Banner Manager",
	"rejected_email_body" => "Dear Sir or Madam,".PHP_EOL.PHP_EOL."We are sorry, but your banner \"{banner_title}\" was not approved. We will do refund as soon as possible.".PHP_EOL.PHP_EOL."Thanks,".PHP_EOL."Banner Manager",
