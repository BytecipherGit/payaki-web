(function ( $ ) {
    ...
    $.fn.orakuploader = function( options ) {
        ...
        jQuery.data(holdername, 'already_uploaded', 0);
        ...
        for (i = 0; i < settings.orakuploader_attach_images.length; i++) {
            ...
            if(settings.orakuploader_hide_on_exceed == true && parseInt(jQuery.data(holdername, 'already_uploaded')) == parseInt(settings.orakuploader_maximum_uploads)) {
                $(holdername).parent().find('.uploadButton').hide();
            }
        }
