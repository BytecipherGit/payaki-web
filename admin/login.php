    ...
    if($recaptcha_responce){
        if(adminlogin($_POST['username'],$_POST['password']))
        {
            if(isset($_POST["remember"]) && $_POST["remember"] == 1) {
                setcookie('quickadmin_remember', $_POST['username'] , time() +3600*24*30,'/', null, null, true);
            } else {
                if(isset($_COOKIE["quickadmin_remember"])) {
                    setcookie ("quickadmin_remember","");
                }
            }
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="remember" class="css-input switch switch-sm switch-app">
                                                <input type="checkbox" id="remember" name="remember" value="1"/><span></span> Remember me</a>
                                            </label>
                                        </div>
