                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="state" id="state" class="form-control js-select2" data-ajax-action="getCityByStateID" data-placeholder="Select region..">
                                        <option value="<?php echo $item_state ?>" selected><?php echo get_stateName_by_id($item_state) ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="city" id="city" class="form-control js-select2" data-placeholder="Select city..">
                                        <option value="<?php echo $item_city ?>" selected><?php echo get_cityName_by_id($item_city) ?></option>
                                    </select>
                                </div>
                            </div>
