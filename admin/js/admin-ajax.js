jQuery(function($) {
    ...
    //Uninstall Country
    $('#ajax-services').on('click', '.uninstall-country', function(e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    //Payment Install
    $('#ajax-services').on('click', '.install-payment', function(e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    //Payment Uninstall
    $('#ajax-services').on('click', '.uninstall-payment', function(e) {
        e.stopPropagation();
        e.preventDefault();
