                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="quickad_settings_general">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_settings_general">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="site_title">Allow Non-login users to Send Email on detail page</label>
                                                                <p class="help-block">When disallow, an Send Email Button Hide to non-login users.</p>
                                                                <select name="non_login_sendemail_allow" id="non_login_sendemail_allow" class="form-control">
                                                                    <option value="1" <?php if(get_option("non_login_sendemail_allow") == '1'){ echo "selected"; } ?>>Allow</option>
                                                                    <option value="0" <?php if(get_option("non_login_sendemail_allow") == '0'){ echo "selected"; } ?>>Disallow</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="site_title">Allow Non-login users to Show Phone number</label>
                                                                <p class="help-block">When disallow, Phone Number Hide to non-login users.</p>
                                                                <select name="non_login_phone_show" id="non_login_phone_show" class="form-control">
                                                                    <option value="1" <?php if(get_option("non_login_phone_show") == '1'){ echo "selected"; } ?>>Allow</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <select name="auto_detect_location" class="form-control">
                                                                        <option <?php if($config['auto_detect_location'] == 'yes'){ echo "selected"; } ?> value="yes">On</option>
                                                                        <option <?php if($config['auto_detect_location'] == 'no'){ echo "selected"; } ?> value="no">Off</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_international">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="lang" id="lang" class="js-select2 form-control" style="width: 100%;">
                                                                    <?php
                                                                    $langs = get_language_list($config['lang'],"selected",true);
                                                                    foreach ($langs as $value)
                                                                    {
                                                                        ...
                                                                        echo '<option value="'.$file_name.'" '.$selected.' data-tokens="'.$name.'">'.$name.'</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="quickad_sms_setting">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_sms_setting">
                                                            <h4>Instructions</h4>

                                                            <div class="form-group">
                                                                <label>SMS Login & Verification Enable/Disable:</label>
                                                                <div>
                                                                    <select name="sms_verify_mode" id="sms_verify_mode" class="form-control">
                                                                        <option <?php if(get_option("sms_verify_mode") == '1'){ echo "selected"; } ?> value="1">Enable</option>
                                                                        <option <?php if(get_option("sms_verify_mode") == '0'){ echo "selected"; } ?> value="0">Disable</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="email_type">SMS Service Provider</label>
                                                                <p class="help-block">SMS connection and sending method. </p>

                                                                <div>
                                                                    <select name="sms_provider" id="sms_provider" class="form-control">
                                                                        <option>Select Any</option>
                                                                        <option value="twilio" <?php if(get_option('sms_provider') == 'twilio'){ echo "selected"; } ?>>Twilio</option>
                                                                        <option value="nexmo" <?php if(get_option('sms_provider') == 'nexmo'){ echo "selected"; } ?>>Nexmo</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="smsProvider-twilio smsProvider" <?php if(get_option('sms_provider') != 'twilio'){ echo 'style="display: none;"'; } ?>>
                                                                <h4 class="text-warning">Twilio</h4><hr>
                                                                <div class="form-group">
                                                                    <label for="twilio_from">Twilio From</label>
                                                                    <input name="twilio_from" class="form-control" type="text" id="twilio_from" value="<?php echo get_option('twilio_from');?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="twilio_account_sid">Twilio account sid</label>
                                                                    <input name="twilio_account_sid" class="form-control" type="text" id="twilio_account_sid" value="<?php echo get_option('twilio_account_sid');?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="twilio_auth_token">Twilio auth token</label>
                                                                    <input name="twilio_auth_token" type="text" class="form-control" id="twilio_auth_token" value="<?php echo get_option('twilio_auth_token');?>">
                                                                </div>
                                                            </div>
                                                            <div class="smsProvider-nexmo smsProvider" <?php if(get_option('sms_provider') != 'nexmo'){ echo 'style="display: none;"'; } ?>>
                                                                <h4 class="text-warning">Nexmo / Vonage</h4><hr>
                                                                <div class="form-group">
                                                                    <label for="vonage_from">Vonage From</label>
                                                                    <input name="vonage_from" class="form-control" type="text" id="vonage_from" value="<?php echo get_option('vonage_from');?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="vonage_api_key">Vonage API Key</label>
                                                                    <input name="vonage_api_key" class="form-control" type="text" id="vonage_api_key" value="<?php echo get_option('vonage_api_key');?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="vonage_api_secret">Vonage API Secret</label>
                                                                    <input name="vonage_api_secret" type="text" class="form-control" id="vonage_api_secret" value="<?php echo get_option('vonage_api_secret'); ?>">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Otp Verification SMS Template:</label>
                                                                <div>
                                                                    <textarea name="sms_otp_template" class="form-control"><?php echo get_option("sms_otp_template"); ?></textarea>
                                                                    <div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <table class="quickad-codes">
                                                                                ...
                                                                                <tr>
                                                                                    <td><input value="{OTP_CODE}" readonly="readonly" onclick="this.select()">- One Time Pass Code (OTP)</td>
                                                                                </tr>
                                                                                <tr>
                                                            ...
                                                            <div class="panel-footer">
                                                                <button name="sms_api_setting" type="submit" class="btn btn-primary btn-radius save-changes">Save</button>
                                                                <button class="btn btn-default" type="reset">Reset</button>
                                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#sms_provider").on('change',function(){
            $(".smsProvider").hide();
            $(".smsProvider-"+$(this).val()).fadeIn('fast');
        });
    });
</script>
<!-- Page JS Code -->
