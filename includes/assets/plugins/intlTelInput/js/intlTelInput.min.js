    ...
    (e.prototype = {
      ...
      _f: function () {
        ...
        this.b.allowDropdown && (b += " allow-dropdown"),
          ...
          if(Object.keys(this.s).length === 0){
            var aa = a("<div>", { class: "selected-flag", tabindex:"0" , title:"Angola: +244" });
            var bb = "iti-flag ao";
            $('#country_code').val('+244');
          } else {
            var aa = a("<div>", { class: "selected-flag" });
            var bb = "iti-flag";
          }
          // console.log(Object.keys(this.s).length);
        // var c = a("<div>", { class: "selected-flag" });
        var c = aa;
        c.appendTo(this.k),
          (this.l = a("<div>", { class: bb }).appendTo(c)),
          this.b.separateDialCode &&
      ...
      _z: function (a) {
        // Start Check Added by lalit
        if(a == ''){
            a = 'ao';
            // $('#country_code').val('+244');
        }
        // End Check Added by lalit
        ...
        var c = a ? this.s.name + ": +" + this.s.dialCode : "Angola: +244";
        if(this.s.dialCode == 244){
            $('#country_code').val('+'+this.s.dialCode);
        } else {
            $('#country_code').val('+'+this.s.dialCode);
        }
        // End Check Added by lalit
